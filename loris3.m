...
% NOTE:
%
% Requires MINMAX, not Matlab's NNDATAFUN/MINMAX.M
%
...
set(ah(length(ah)-2),'xtick',tix2,...
		  'xticklabel',round(10*tix2)/10,'xgrid','on')
set(ah(length(ah)-1),'xtick',tix4,...
		  'xticklabel',round(10*tix4)/10,'xgrid','on')
